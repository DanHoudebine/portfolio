...
export default function Hero3D() {
  ...
  useEffect(() => {
    ...
    renderer.setClearColor(new THREE.Color('#000b1f'));
    ...
    const letterColors = ['#ff7f00', '#C75B12', '#C9680C', '#ffd700', '#C75B12', '#ff7f00'];
    ...
    // ─── Wireframe Grid ───
    const grid = new THREE.GridHelper(20, 40, new THREE.Color('#ff7f00'), new THREE.Color('#1d2b54'));
    grid.position.y = -1.5;
