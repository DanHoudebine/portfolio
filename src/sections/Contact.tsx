...
export default function Contact() {
  ...
  const socialLinks = [
    {
      label: 'ArtStation',
      url: 'https://www.artstation.com/danhoudebine',
      icon: <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: '18px', height: '18px' }}>
    ...
    {
      label: 'LinkedIn',
      url: 'https://www.linkedin.com/in/danhoudebine',
      icon: <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: '18px', height: '18px' }}>
    ...
    {
      label: 'GitHub',
      url: 'https://github.com/DanHoudebine',
      icon: <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: '18px', height: '18px' }}>
        ...
        <div>
          ...
          <div className="reveal-item">
            ...
            >
              ...
              <span
                className="absolute left-0 bottom-0 h-[1px] bg-[#c96f2e] transition-all duration-300 group-hover:w-[120%] group-hover:bg-[#e08840]"
            ...
            {socialLinks.map((social, i) => (
              <a
                ...
                style={{
                  width: '40px',
                  height: '40px',
                  border: '1px solid rgba(143,163,187,0.25)',
                  color: '#8fa3bb',
                }}
                onMouseEnter={(e) => {
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = 'rgba(143,163,187,0.25)';
          ...
          {submitted ? (
            <div className="h-full flex items-center justify-center">
              <p
                ...
                style={{ fontSize: '24px', color: '#c96f2e' }}
              >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              <input
                ...
                required
                className="bg-transparent border-b font-body text-white placeholder-white/40 focus:outline-none transition-colors duration-300 focus:border-[#c96f2e]"
                style={{
                  fontSize: '16px',
                  padding: '16px 0',
              ...
              <textarea
                ...
                required
                rows={5}
                className="bg-transparent border-b font-body text-white placeholder-white/40 focus:outline-none transition-colors duration-300 focus:border-[#c96f2e] resize-none"
                style={{
                  fontSize: '16px',
                  padding: '16px 0',
                  borderColor: 'rgba(255,255,255,0.15)',
              ...
              <button
                type="submit"
                className="font-body font-semibold uppercase tracking-[0.1em] transition-all duration-300 hover:bg-[#e08840]"
                style={{
                  fontSize: '15px',
                  padding: '18px',
                  background: '#c96f2e',
